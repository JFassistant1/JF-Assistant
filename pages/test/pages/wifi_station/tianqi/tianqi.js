...
Page({
  ...
  convert: function () {
    ...
    for (var i = 0; i < length; i++) {
      categories.push(app.globalData.weight.datapoints[i].at.slice(11,19));
      weight.push(app.globalData.weight.datapoints[i].value);
